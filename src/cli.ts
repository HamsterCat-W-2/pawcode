...
import { OpenAICompatibleAdapter } from "./models/openai-compatible-adapter.js";
...
async function main(): Promise<void> {
  ...
  await runInteractive(runtime, modelName);
}

async function runInteractive(runtime: AgentRuntime, modelName: string): Promise<void> {
